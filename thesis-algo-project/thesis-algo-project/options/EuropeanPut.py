...
class EuropeanPut:
    ...
    def put_price(self, S=None, sigma=None, r=None, N=None, K=None, dt=None):
    ...
    def put_delta(self, S=None, sigma=None, r=None, N=None, K=None, dt=None):
    ...
    def put_pnl(self, S=None, payoff=None, delta=None, dt=None, r=None, eps=None):
        N = S.shape[1] - 1
